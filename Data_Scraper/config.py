...
MAIN_EXCEL = OUTPUT_DIR / "nachr_extracted_data.xlsx"
INACCESSIBLE_EXCEL = OUTPUT_DIR / "inaccessible_papers.xlsx"
...
# ── Excel Column Order (matches nachr_db_manual.xlsx) ────────────────────────
EXCEL_COLUMNS = [
    "OID",
    "nAChR subunit",
    "Modification type",
...
GEMINI_DELAY_SECONDS = 4  # ~15 RPM free tier
UNPAYWALL_EMAIL = NCBI_EMAIL  # Unpaywall requires an email
