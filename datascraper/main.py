"""
Build a ranked worklist of candidate MOUSE nAChR mutation-electrophysiology
papers for manual curation, aggregated across three sources:
  ...
  * UniProt    — curated mouse mutagenesis/variant annotations (mutation + effect
...
def collect(subunits, sources):
    ...
    if "uniprot" in sources:
        print("\n" + "=" * 60 + "\nSOURCE: UniProt (mouse mutagenesis)\n" + "=" * 60)
...
def main():
    ...
    print("nAChR mouse-paper worklist builder")
