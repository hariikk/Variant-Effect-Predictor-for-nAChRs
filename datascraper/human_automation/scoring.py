...
regex signals that indicate it reports a HUMAN nAChR MUTATION studied by
...
SPECIES_TERMS = [
    ...
    "clinical", "individual", "family", "kindred",
]
...
def score_paper(title: str, abstract: str, uniprot_curated: bool = False) -> dict:
    ...
    species = _matched_terms(lower, SPECIES_TERMS)
    ...
    score += w["species"] if species else 0
